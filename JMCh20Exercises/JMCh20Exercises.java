...
public class JMCh20Exercises<E>
{
    ...
    public int sizeFor( ListNode<E> head )
    {
        ...
        count++;
        for (ListNode<E> temp = head; temp.getNext() != null; temp = temp.getNext()) {
            count++;
        }
    ...
    public ListNode<E> reverseList( ListNode<E> head )
    {
        ...
        ListNode<E> output = new ListNode<E>(head.getValue(),null);
        ListNode<E> chaser = output;
        while (head.getNext() != null) {
            head = head.getNext();
            output = new ListNode<E>(head.getValue(),chaser);
            chaser = output;   
        }
        return output;
    }
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        String concatString = head.getValue();
        ListNode<String> newHead = new ListNode<String>(concatString,null);
        ListNode<String> output = newHead;
        while (head.getNext() != null) {
            head = head.getNext();
            concatString += head.getValue();
            //System.out.println(concatString);
            output.setNext(new ListNode<String>(concatString, null));
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        if (s.compareTo(head.getValue()) < 0) {
            ListNode<String> newHead = new ListNode<String>(s,head);
            return newHead;
        }
        ListNode<String> chaser = head;
        ...
        while (temp.getNext() != null) {
            ...
            else if (s.compareTo(temp.getValue()) < 0) {
                //System.out.println("Ping: " + s + " " + temp.getValue());
                //System.out.println(chaser.getValue());
                chaser.setNext(new ListNode<String>(s,temp));
                return head;
            }
            chaser = chaser.getNext();
        }
        
        temp.setNext(new ListNode<String>(s,null));
        return head;
    }
    ...
    {
        // Outer Loop
        ListNode<String> outerLoop = head;

        ListNode<String> i;
        ListNode<String> minimum;
        String tempStorage;
        ...
        while (outerLoop.getNext() != null) {
            minimum = outerLoop;
            i = outerLoop;
            while(i.getNext() != null) {
                if (i.getValue().compareTo(minimum.getValue()) < 0) {
                    minimum = i;
                }
                i = i.getNext();
            }
            // Swap values
            tempStorage = outerLoop.getValue();
            outerLoop.setValue(minimum.getValue());
            minimum.setValue(tempStorage);
    ...
    {
        ListNode2<Integer> maximum = head;
        ListNode2<Integer> temp = head;
        while (temp.getNext() != null) {
            if (temp.getNext().getValue().compareTo(maximum.getValue()) > 0) {
                maximum = temp;
            }
            temp = temp.getNext();
        }
        ...
        while (temp.getNext() != maximum) {
            temp = temp.getNext();
        }
        temp.setNext(maximum.getNext());
        return head;
    }
